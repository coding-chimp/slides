...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Slides web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 9H7mSNqYdD3qyvPl78Am19zw7Pp2VOqofVBMgOlIQXA
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("slides.log", "w"))
  #
  #
end
